...
class Array
  def clean_up()
    #self.join(" ").split(" ").uniq   #this is old method could be more elegant
     self.flat_map(&:split).uniq      #new method that looks more elegant and efficient but is it really??????
  end
end
